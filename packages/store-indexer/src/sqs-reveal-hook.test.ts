...
describe("extractRevealCodes", () => {
  ...
  it("extracts code from a reveal log (state=IDLE)", () => {
    // TaruchiStatus static layout (post-B1): affinity(1) + state(1) + level(1) + xp(4)
    // + trainingPoints(1) + traits(5) + stats(16) + budIndex(1) = 30 bytes. traits @8..13.
    ...
    const staticData =
      ...
      "00000000000000000000000000000000" + // stats (uint128): 0
      "00"; // budIndex: 0
  ...
  it("ignores non-SetRecord events", () => {
    const staticData =
      "0x" + "03" + "01" + "01" + "00000000" + "00" + "0205030101" + "00000000000000000000000000000000" + "00";
  ...
  it("ignores non-IDLE state", () => {
    // state=2 (ENROLLED)
    const staticData =
      "0x" + "03" + "02" + "01" + "00000000" + "00" + "0205030101" + "00000000000000000000000000000000" + "00";
    const logs = [makeLog("Store_SetRecord", TARUCHI_STATUS_TABLE_ID, staticData)];
    expect(extractRevealCodes(logs)).toEqual([]);
  });
  ...
  it("extracts multiple reveals from one block", () => {
    ...
    const staticData2 =
      "0x" + "05" + "01" + "01" + "00000000" + "00" + "0003050c00" + "00000000000000000000000000000000" + "00";
    const logs = [
